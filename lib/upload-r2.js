...
const R2_BUCKET = process.env.POLSIA_R2_BUCKET || 'wageos-avatars';
const R2_ENDPOINT = process.env.POLSIA_R2_ENDPOINT; // e.g. https://abc123.r2.cloudflarestorage.com
const R2_ACCESS_KEY = process.env.POLSIA_R2_ACCESS_KEY_ID;
const R2_SECRET_KEY = process.env.POLSIA_R2_SECRET_ACCESS_KEY;
...
if (R2_ENDPOINT && R2_ACCESS_KEY && R2_SECRET_KEY) {
  ...
  console.warn('[upload-r2] R2 env vars not set — uploads will use base64 fallback. Set POLSIA_R2_ENDPOINT, POLSIA_R2_ACCESS_KEY_ID, POLSIA_R2_SECRET_ACCESS_KEY.');
}

const BASE_URL = process.env.POLSIA_R2_PUBLIC_URL || 'https://pub-629428d185ca4960a0a73c850d32294b.r2.dev';
